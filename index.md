...
I had seen data structures and algorithms before in CS-300, but they felt more practical in the capstone. The original weight tracking app stored entries, but it did not do much with them after that. The Algorithms and Data Structures enhancement changed that by adding date-range filtering, a trend summary, sorting, and real-time search.
